              ...
              <tr class="hover:bg-grey-lighter">
                ...
                <td class="py-4 px-6 border-b border-grey-light flex justify-center">
                  ...
                  <form action="{{ route('todo.destroy', $todo->id)}}" method="POST">
                    @method('delete')
                    @csrf
                    <button type="submit" class="mr-2 ml-2 bg-black hover:bg-gray-900 hover:shadow-none text-white py-1 px-2 focus:outline-none focus:shadow-outline" onclick="alert('本当に削除しても良いですか？')">
                      <svg class="h-6 w-6 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="white">
